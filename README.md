...
![Tampermonkey](https://img.shields.io/badge/Tampermonkey-compatible-green) ![Version](https://img.shields.io/badge/version-2.9.1-blue)
...
### v2.9.1
- **Fix All Open filter** — always wrap search queries in AND operator so single-condition queries work correctly with Intercom API
